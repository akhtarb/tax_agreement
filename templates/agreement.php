...
Sales and Use Tax Agreement
  This Agreement is made and entered into on <?=$approved_date?> of 2014 between  Appalachian State University("University")and the   <?=$organization_name?>.
	WHEREAS, Student Organization is renting space on University’s campus, located at   <?=$eventlocation?>, for the <?=$event_name?>  on <?=$event_date?>].
